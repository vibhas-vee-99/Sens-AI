...
export default function Home() {
  return (
    <div>
      ...
      <section className="w-full py-12 md:py-24 bg-muted/50">
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            ...
            {/*adding the below stats section of the landing page*/}
      ...
      {/*statistics section of the landing page*/}
      <section className="w-full py-12 md:py-24 lg:py-32 bg-background">
        <div className="container mx-auto px-4 md:px-6">
            ...
            {howItWorks.map((item, index) => {
              return (
                <div key={index}
                  ...
                  <h3 className="font-semibold text-x1">{item.title}</h3>
      ...
      {/*getting started section with a dancing button*/}
      <section className="w-full">
        <div className="mx-auto py-24 gradient rounded-lg">

          <div className="flex flex-col item-center justify-center space-y-4 text-center max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold tracking-tighter text-primary-foreground sm:text-4xl md:text-5xl">
              Ready To Accelerate Your Career?
            </h2>
            <p className="mx-auto max-w-[600px] text-primary-foreground/80 md:text-xl">
              Join thousands of professionals using our platform to land their dream jobs with AI powered guidance.
            </p>
